...
import { createCourse, getCourses, getCourseById, getInstructorCourses, updateCourse, deleteCourse, getEnrolledCourses, subscribeFcm } from "./course.controller.js";
...
router.post("/push/subscribe", protect, subscribeFcm);
